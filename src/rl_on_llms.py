...
Original file is located at
    https://colab.research.google.com/drive/1LEGMWw9Pl8qK_caoYUK8rx8jh8vnmm5x
"""
...
def get_PDDL_noAction(node):
  ...
  "Here is an example PDDL in blocksworld domain with 3 blocks: Red,Blue,Green. Red block is on the table. Blue block is on top of Red block. Green block is the topmost block and it is on top of Blue block."
  "Current state of game: (define (problem)" #RBG
  "(:domain blocksworld)"
  "(:objects Red Blue Green)"
  "(:init (on-table Red)"
  "((Blue on Red) and (Green on Blue))"
  "(clear Green)"
  "(arm-empty))"
  )
