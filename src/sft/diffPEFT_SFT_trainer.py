...
output_dir=cfg['training']['output_dir']+'/training/training_05-06'
...
#change for pad token id -> ignore index
...
checkpoint_path=f"/srv/chawak/planning-with-llms/results/SFT/training/training_01-06/checkpoint-{cpt}"
...
def train(train_data,eval_data,model):
    ...
    data_collator=wrapped_collator, #change for pad token id -> ignore index
